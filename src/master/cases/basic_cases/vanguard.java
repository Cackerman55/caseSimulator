 ...
 * @author cackerman
 */
public class vanguard extends javax.swing.JFrame {
    ...
    public static String path = "/guis/icons/basic_cases/Vanguard/";
    public static final String statement = "Value: $";
    public static double[] rValues = {42.76,10.02,3.31,3.18,3.49,.41,2,1.24,.45,.34,.17,.23,.25,.26};
    public static double[] sValues = {264.25,66.14,10.12,16.4,20.25,3.29,13.15,6.42,2.1,1.82,.61,1.21,.63,1.97};
    public static int[] statT = {0,0,0,0,0};
    public static int[] reg = {0,0,0,0,0};
    public static int[] knifeLoadout = {19,13,13,19,19,13,19,19};
    /**
     * Creates new form vanguard
     */
    public vanguard() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setTitle("Operation Vanguard case");
        ...
        knifeBanner.setIcon(new javax.swing.ImageIcon(getClass().getResource("/guis/icons/basic_cases/Vanguard/covert1.png"))); // NOI18N
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/guis/background/vanguardHead.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(vanguard.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
