 ...
 * @author cackerman
 */
public class chroma1 extends javax.swing.JFrame {
    ...
    public static String path = "/guis/icons/basic_cases/Chroma1/";
    public static final String statement = "Value: $";
    public static double[] rValues = {15.61,10.64,3.33,2.35,4.88,.76,.43,.41,.4,.11,.12,.08,.21,.09};
    public static double[] sValues = {41.1,53.1,42.72,10.2,43.91,4.02,2.04,1.75,1.83,1.15,.49,.31,.87,.38};
    public static int[] statT = {0,0,0,0,0};
    public static int[] reg = {0,0,0,0,0};
    public static int[] knifeLoadout = {19,13,13,19,19,13,19,19};
    /**
     * Creates new form chroma1
     */
    public chroma1() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/guis/background/chromaHead.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(chroma1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
