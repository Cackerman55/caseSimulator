...
public class phoenix extends javax.swing.JFrame {
    ...
    public static double caseV = 2.54;
    public static String choice = "";
    public static String path = "/guis/icons/basic_cases/Phoenix/";
    public static final String statement = "Value: $";
    public static double[] rValues = {2.03,40.05,3.1,10.86,3.36,.78,.69,.64,.64,.1,.1,.11,.09};
    public static double[] sValues = {9.72,134,10.97,55.27,8.69,2.46,2.72,2.44,3.37,.74,.24,.78,.28};
    ...
    private void initComponents() {
        ...
        setTitle("Operation Phoenix case");
        setMinimumSize(new java.awt.Dimension(1095, 735));
        getContentPane().setLayout(null);

        open1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/guis/background/open.png"))); // NOI18N
        ...
        open1.setBounds(290, 490, 310, 70);
        ...
        knifeBanner.setIcon(new javax.swing.ImageIcon(getClass().getResource("/guis/icons/basic_cases/Phoenix/covert1.png"))); // NOI18N
